...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message'])) {
    ...
    $recipientEmail = 'sgmcmed@gmail.com'; // Replace with the recipient's email address
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'sgmcmed@gmail.com'; // Your SMTP username
        $mail->Password = 'uluztdclouiorytp'; // Your SMTP password
